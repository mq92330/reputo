...
const articles = {
  ...
  'avis-google-sante': {
    ...
    content: [
      ...
      { h2: "Le secret médical : un frein spécifique à la santé", p: "Contrairement à un restaurateur, un professionnel de santé ne peut pas répondre publiquement à un avis négatif sans risquer de violer le secret médical. Il ne peut pas dire 'Monsieur X, votre douleur est due à...'. Cette contrainte déontologique rend la prévention encore plus cruciale : il faut recueillir la satisfaction de tous les patients activement, pas attendre que les mécontents agissent seuls." },
      { h2: "Ce que change Reputo", p: "Reputo envoie un SMS après chaque consultation avec un lien de notation. Tous les patients sont ensuite invités à partager leur expérience sur Google. Un formulaire privé permet aussi à chacun d'envoyer un retour direct au praticien — pour traiter les insatisfactions avant qu'elles deviennent des problèmes." },
    ]
  },
  'comment-collecter-avis-google-cabinet': {
    ...
    content: [
      ...
      { h2: "Étape 4 : Le filtre étoiles pour protéger votre réputation", p: "Configurez votre seuil de satisfaction (4 étoiles par défaut). Après la notation, tous vos patients sont invités à partager leur expérience sur Google. Un formulaire privé est aussi proposé à chacun pour vous envoyer un retour direct — sans contrainte de secret médical, pour transformer un patient déçu en patient fidèle." },
    ]
  },
  ...
  'reputo-dentiste': {
    ...
    content: [
      ...
      { h2: "Le flow concret : comment 143 avis en 3 mois changent un cabinet", p: "L'assistante du cabinet envoie le SMS après chaque soin. Sur 143 notes reçues en 3 mois, 11 étaient sous le seuil de 4 étoiles — 5 concernaient l'attente, 4 les honoraires, 2 étaient incompréhensibles. Ces 11 patients ont utilisé le formulaire privé Reputo pour exprimer leurs réserves. Le praticien a répondu à chacun, a expliqué ses honoraires, proposé un devis détaillé. Résultat : aucun n'a posté d'avis négatif public. Deux sont devenus des patients réguliers." },
  ...
  'reputo-infirmier-liberal': {
    ...
    content: [
      ...
      { h2: "Protéger son travail avec un retour privé sur la ponctualité", p: "Reputo permet à l'IDEL de recevoir les retours directs de ses patients via un formulaire privé. Un patient mécontent du retard envoie son message directement à l'infirmière, qui peut expliquer : 'Madame X, j'avais une urgence chez un patient en détresse ce matin, je m'en excuse.' Dans 90 % des cas, cette réponse privée désarme la frustration. Le patient comprend. L'avis négatif n'est jamais posté." },
    ]
  },
  'reputo-ophtalmo': {
