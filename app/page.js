      ...
      <section className={styles.section}>
        <div className={styles.sectionInner} style={{maxWidth:'700px'}}>
          ...
          <div className={styles.faqs}>
            {[
              { q:"Est-ce conforme au RGPD et au secret médical ?", a:"Oui. Reputo ne collecte aucune donnée médicale. Seul le numéro de téléphone est utilisé, et il est supprimé après envoi du SMS. Aucun contenu médical n'est traité ou stocké. Hébergement en France." },
